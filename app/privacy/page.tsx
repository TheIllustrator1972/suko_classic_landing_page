  ...
  return (
    <div className="p-10">
      ...
      <ul>
        ...
        <li>
          <p>
            <strong>Application</strong> refers to Suko Classic, the software
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Suko Classic.
          </p>
        </li>
        <li>
          <p>
      ...
      <ul>
        <li>
          <p>By email: theillustrator2001@gmail.com</p>
        </li>
        <li>
          <p>
            By visiting this page on our website:{" "}
            <a
              href="https://suko-classic-landing-page.vercel.app/"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://suko-classic-landing-page.vercel.app/
            </a>
          </p>
        </li>
      </ul>
